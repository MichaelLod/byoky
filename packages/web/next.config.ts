    ...
    return [
      {
        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://avatars.githubusercontent.com https://unpkg.com https://api.producthunt.com; connect-src 'self' wss://*.byoky.com https://*.byoky.com https://api.github.com https://gist.githubusercontent.com; frame-ancestors 'none';",
          },
        ],
      },
      {

...
function highlightCode(code: string): ReactNode[] {
  ...
  return lines.map((line, i) => {
    ...
    while (remaining.length > 0) {
      ...
      // Strings (single and double quoted, backtick)
      ...
      // Keywords
      const kwMatch = remaining.match(/^(import|from|export|const|let|var|await|async|new|true|false|null|undefined)\b/);
      if (kwMatch) {
      ...
      // Types / constructors (capitalized words)
      ...
      // Plain text (consume one char at a time for non-matches, or batch plain text)

...
// Encrypt/decrypt with a pre-derived CryptoKey. Ciphertext format: base64(iv || ciphertext+tag).
// Used for vault sync, where client and server share a key derived from (password, encryptionSalt).

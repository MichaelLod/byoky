...
struct Provider: Identifiable, Hashable {
    ...
    static let all: [Provider] = [
        ...
        Provider(id: "cohere", name: "Cohere", baseUrl: "https://api.cohere.com", icon: "text.bubble"),
        ...
        Provider(id: "azure_openai", name: "Azure OpenAI", baseUrl: "https://openai.azure.com", icon: "cloud"),
    ]
